...
Check the [releases](https://github.com/droboports/python-cheetah/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/python-cheetah.git
cd python-cheetah
./build.sh
ls -la *.egg
```
